...
// 4. REVIEW: Print out all 5 items in this list. Why does this seem like a lot of work?
...
// 5. Add 5 of your favorite songs to the list. Use a for loop to print out each item by saying "I like to listen to Halo", "I like to liste to Crazy in Love", etc.
var favoriteSongs = [] 
...
// 6. BRING IT TOGETHER: I have given you a large list of numbers with scores from a recent project. I have made a typo in everyons grade and they are too large. Divide each grade my 100 to get the actual grade. Print out the correct value to the console.
...
// 7. Double triple bonus challenge: Check this list above. If the grade listed in the original list is larger than 1800, I want them to be added to the new list called "high grades". Print out the size of this list when the for loop is done
var highGrades = [];